...
function () {
  function AMCache() {
    (0, _classCallCheck2.default)(this, AMCache);
  }

  (0, _createClass2.default)(AMCache, null, [{
    key: "addObjects",
      ...
      return new Promise(function (fulfill, reject) {
        ...
        AMCache._getCache(type).then(function (cache) {
          ...
          if (cache && Object.prototype.toString.call(cache) !== '[object Array]' && !replaceAll) {
            console.warn('cache are not an array of objects', (0, _typeof2.default)(cache));
            cache = null;
    ...
    value: function mergeAndSetCache(cache, objects, type) {
      objects = AMCache.merge(cache, objects); // store the new cache
